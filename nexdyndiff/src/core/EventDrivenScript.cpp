...
int nexdyndiff::EventDrivenScript::add_event(std::function<void(EventInfo&)> action, std::function<bool(EventInfo&)> run_when, std::function<bool(EventInfo&)> delete_when)
{
...
void nexdyndiff::EventDrivenScript::run_a_cycle(double time)
{
...
void nexdyndiff::EventDrivenScript::clear()
{
	this->events.clear();
}
