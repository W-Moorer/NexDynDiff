...
namespace nexdyndiff::core
{
	/*
	* nexdyndiff allows the user to inject functionality in the main simulation loop (including the minimizer) by a system of callbacks.
