...
{
	this->dof_v = nexdyndiff.global_energy.add_dof_array(this->v1, "rb_v1");
	this->dof_w = nexdyndiff.global_energy.add_dof_array(this->w1, "rb_w1");
...
int nexdyndiff::RigidBodyDynamics::add(const std::string& label)
{
...
int nexdyndiff::RigidBodyDynamics::get_n_bodies() const
{
	return (int)this->t0.size();
}

symx::Vector nexdyndiff::RigidBodyDynamics::get_x1(symx::Energy& energy, const symx::Index& rb_idx, const symx::Vector& x_loc, const symx::Scalar& dt)
{
	return this->get_x1(energy, rb_idx, std::vector<symx::Vector>({ x_loc }), dt)[0];
}
std::vector<symx::Vector> nexdyndiff::RigidBodyDynamics::get_x1(symx::Energy& energy, const symx::Index& rb_idx, const std::vector<symx::Vector>& x_loc, const symx::Scalar& dt)
{
...
symx::Vector nexdyndiff::RigidBodyDynamics::get_v1(symx::Energy& energy, const symx::Index& rb_idx, const symx::Vector& x_loc, const symx::Scalar& dt)
{
	return this->get_v1(energy, rb_idx, std::vector<symx::Vector>({ x_loc }), dt)[0];
}
std::vector<symx::Vector> nexdyndiff::RigidBodyDynamics::get_v1(symx::Energy& energy, const symx::Index& rb_idx, const std::vector<symx::Vector>& x_loc, const symx::Scalar& dt)
{
	symx::Vector v1 = energy.make_dof_vector(this->dof_v, this->v1, rb_idx);
	symx::Vector w1 = energy.make_dof_vector(this->dof_w, this->w1, rb_idx);
	symx::Vector t0 = energy.make_vector(this->t0, rb_idx);
...
symx::Vector nexdyndiff::RigidBodyDynamics::get_d1(symx::Energy& energy, const symx::Index& rb_idx, const symx::Vector& d_loc, const symx::Scalar& dt)
{
	symx::Vector w1 = energy.make_dof_vector(this->dof_w, this->w1, rb_idx);
	symx::Vector q0 = energy.make_vector(this->q0_, rb_idx);
	return integrate_loc_direction(d_loc, q0, w1, dt);
}
std::array<symx::Vector, 2> nexdyndiff::RigidBodyDynamics::get_x1_d1(symx::Energy& energy, const symx::Index& rb_idx, const symx::Vector& x_loc, const symx::Vector& d_loc, const symx::Scalar& dt)
{
	symx::Vector v1 = energy.make_dof_vector(this->dof_v, this->v1, rb_idx);
	symx::Vector w1 = energy.make_dof_vector(this->dof_w, this->w1, rb_idx);
	symx::Vector t0 = energy.make_vector(this->t0, rb_idx);
...
std::array<symx::Vector, 2> nexdyndiff::RigidBodyDynamics::get_x0_x1(symx::Energy& energy, const symx::Index& rb_idx, const symx::Vector& x_loc, const symx::Scalar& dt)
{
	symx::Vector v1 = energy.make_dof_vector(this->dof_v, this->v1, rb_idx);
	symx::Vector w1 = energy.make_dof_vector(this->dof_w, this->w1, rb_idx);
	symx::Vector t0 = energy.make_vector(this->t0, rb_idx);
...
Eigen::Vector3d nexdyndiff::RigidBodyDynamics::get_x1(int rb, const Eigen::Vector3d& x_loc, double dt) const
{
	return integrate_loc_point(x_loc, this->t0[rb], this->q0[rb], this->v1[rb], this->w1[rb], dt);
}
Eigen::Vector3d nexdyndiff::RigidBodyDynamics::get_d1(int rb, const Eigen::Vector3d& d_loc, double dt) const
{
	return integrate_loc_direction(d_loc, this->q0[rb], this->w1[rb], dt);
}

Eigen::Vector3d nexdyndiff::RigidBodyDynamics::get_position_at(int rb, const Eigen::Vector3d& x_loc) const
{
	return local_to_global_point(x_loc, this->R1[rb], this->t1[rb]);
}
Eigen::Vector3d nexdyndiff::RigidBodyDynamics::get_velocity_at(int rb, const Eigen::Vector3d& x_loc) const
{
	return this->v1[rb] + this->w1[rb].cross((this->get_position_at(rb, x_loc) - this->t1[rb]));
}
Eigen::Vector3d nexdyndiff::RigidBodyDynamics::get_direction(int rb, const Eigen::Vector3d& d_loc) const
{
	return local_to_global_direction(d_loc, this->R1[rb]);
}

void nexdyndiff::RigidBodyDynamics::_before_time_step(nexdyndiff::core::NexDynDiff& nexdyndiff)
{
	// Quaternions
...
void nexdyndiff::RigidBodyDynamics::_on_time_step_accepted(nexdyndiff::core::NexDynDiff& nexdyndiff)
{
