...
Eigen::Matrix3d nexdyndiff::inertia_tensor_cylinder(double mass, double radius, double full_height)
{
...
Eigen::Matrix3d nexdyndiff::inertia_tensor_box(double mass, double size)
{
...
Eigen::Matrix3d nexdyndiff::inertia_tensor_box(double mass, const Eigen::Vector3d& size)
{
...
Eigen::Matrix3d nexdyndiff::inertia_tensor_torus(double mass, double b, double a)
{
    double a2 = a*a;
    double b2 = b*b;
