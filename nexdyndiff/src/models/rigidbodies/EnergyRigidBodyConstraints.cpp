	...
	: rb(rb)
{
	...
	// Energy declarations
	nexdyndiff.global_energy.add_energy("rb_constraint_global_points", this->global_points->conn,
	...
	nexdyndiff.global_energy.add_energy("rb_constraint_global_directions", this->global_directions->conn,
		[&](symx::Energy& energy, symx::Element& conn)
		{
	...
	nexdyndiff.global_energy.add_energy("rb_constraint_points", this->points->conn,
		[&](symx::Energy& energy, symx::Element& conn)
		{
	...
	nexdyndiff.global_energy.add_energy("rb_constraint_point_on_axis", this->point_on_axes->conn,
		[&](symx::Energy& energy, symx::Element& conn)
		{
	...
	nexdyndiff.global_energy.add_energy("rb_constraint_distances", this->distances->conn,
		[&](symx::Energy& energy, symx::Element& conn)
		{
	...
	nexdyndiff.global_energy.add_energy("rb_constraint_distance_limits", this->distance_limits->conn,
		[&](symx::Energy& energy, symx::Element& conn)
		{
	...
	nexdyndiff.global_energy.add_energy("rb_constraint_directions", this->directions->conn,
		[&](symx::Energy& energy, symx::Element& conn)
		{
	...
	nexdyndiff.global_energy.add_energy("rb_constraint_angle_limits", this->angle_limits->conn,
		[&](symx::Energy& energy, symx::Element& conn)
		{
	...
	nexdyndiff.global_energy.add_energy("rb_constraint_damped_spring", this->damped_springs->conn,
		[&](symx::Energy& energy, symx::Element& conn)
		{
	...
	nexdyndiff.global_energy.add_energy("rb_constraint_linear_velocity", this->linear_velocity->conn,
		[&](symx::Energy& energy, symx::Element& conn)
		{
	...
	nexdyndiff.global_energy.add_energy("rb_constraint_angular_velocity", this->angular_velocity->conn,
		[&](symx::Energy& energy, symx::Element& conn)
		{
...
bool nexdyndiff::EnergyRigidBodyConstraints::_is_converged_state_valid(core::NexDynDiff& nexdyndiff)
{
	/*
		Hardens every constraints that has gone beyond the input tolerance.
		If no constraint needs to be hardened, return true.
	*/
	const bool valid = this->_adjust_constraints_stiffness_and_log(nexdyndiff, 1.0, this->stiffness_hard_multiplier, /* are_positions_set = */ false);
	if (!valid) {
		nexdyndiff.console.add_error_msg("Rigid body constraints are not within tolerance. Hardening bending_stiffness.");
	}
	return valid;
}

void nexdyndiff::EnergyRigidBodyConstraints::_on_time_step_accepted(core::NexDynDiff& nexdyndiff)
{
	/*
	...
	*/
	this->_adjust_constraints_stiffness_and_log(nexdyndiff, this->soft_constraint_capacity_hardening_point, this->stiffness_soft_multiplier, /* are_positions_set = */ true);
}

bool nexdyndiff::EnergyRigidBodyConstraints::_adjust_constraints_stiffness_and_log(core::NexDynDiff& nexdyndiff, double cap, double multiplier, bool are_positions_set)
{
	/*
