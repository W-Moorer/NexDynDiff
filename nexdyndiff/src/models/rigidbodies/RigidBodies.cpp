...
nexdyndiff::RigidBodies::RigidBodies(core::NexDynDiff& nexdyndiff, spRigidBodyDynamics rb)
	: rb(rb), output(nexdyndiff, rb)
{
	this->inertia = std::make_shared<EnergyRigidBodyInertia>(nexdyndiff, rb);
	this->constraints = std::make_shared<EnergyRigidBodyConstraints>(nexdyndiff, rb);
}

void nexdyndiff::RigidBodies::set_default_constraint_stiffness(double stiffness)
{
	this->default_stiffness = stiffness;
}
void nexdyndiff::RigidBodies::set_default_constraint_distance_tolerance(double tolerance_in_m)
{
	this->default_tolerance_in_m = tolerance_in_m;
}
void nexdyndiff::RigidBodies::set_default_constraint_angle_tolerance(double tolerance_in_deg)
{
	this->default_tolerance_in_deg = tolerance_in_deg;
}
double nexdyndiff::RigidBodies::get_default_constraint_stiffness() const
{
	return this->default_stiffness;
}
double nexdyndiff::RigidBodies::get_default_constraint_distance_tolerance() const
{
	return this->default_tolerance_in_m;
}
double nexdyndiff::RigidBodies::get_default_constraint_angle_tolerance() const
{
	return this->default_tolerance_in_deg;
}
nexdyndiff::RigidBodyHandler nexdyndiff::RigidBodies::add(const double mass, const Eigen::Matrix3d& inertia_local)
{
...
nexdyndiff::RBCGlobalPointHandler nexdyndiff::RigidBodies::add_constraint_global_point(const RigidBodyHandler& body, const Eigen::Vector3d& p_glob)
{
...
nexdyndiff::RBCGlobalDirectionHandler nexdyndiff::RigidBodies::add_constraint_global_direction(const RigidBodyHandler& body, const Eigen::Vector3d& d_glob)
{
...
nexdyndiff::RBCPointHandler nexdyndiff::RigidBodies::add_constraint_point(const RigidBodyHandler& body_a, const RigidBodyHandler& body_b, const Eigen::Vector3d& p_glob)
{
...
nexdyndiff::RBCPointOnAxisHandler nexdyndiff::RigidBodies::add_constraint_point_on_axis(const RigidBodyHandler& body_a, const RigidBodyHandler& body_b, const Eigen::Vector3d& p_glob, const Eigen::Vector3d& d_glob)
{
...
nexdyndiff::RBCDistanceHandler nexdyndiff::RigidBodies::add_constraint_distance(const RigidBodyHandler& body_a, const RigidBodyHandler& body_b, const Eigen::Vector3d& a_glob, const Eigen::Vector3d& b_glob)
{
...
nexdyndiff::RBCDistanceLimitHandler nexdyndiff::RigidBodies::add_constraint_distance_limits(const RigidBodyHandler& body_a, const RigidBodyHandler& body_b, const Eigen::Vector3d& a_glob, const Eigen::Vector3d& b_glob, double min_distance, double max_distance)
{
	...
	if (d < min_distance || max_distance < d) {
		std::cout << "nexdyndiff error: RigidBodies::add_constraint_distance_limits() got a rest distance out of limits for bodies " << body_a.get_label() << " and " << body_b.get_label() << std::endl;
		exit(-1);
	}
...
nexdyndiff::RBCDirectionHandler nexdyndiff::RigidBodies::add_constraint_direction(const RigidBodyHandler& body_a, const RigidBodyHandler& body_b, const Eigen::Vector3d& d_glob)
{
...
nexdyndiff::RBCAngleLimitHandler nexdyndiff::RigidBodies::add_constraint_angle_limit(const RigidBodyHandler& body_a, const RigidBodyHandler& body_b, const Eigen::Vector3d& d_glob, double admissible_angle_deg)
{
...
nexdyndiff::RBCDampedSpringHandler nexdyndiff::RigidBodies::add_constraint_spring(const RigidBodyHandler& body_a, const RigidBodyHandler& body_b, const Eigen::Vector3d& a_glob, const Eigen::Vector3d& b_glob, double stiffness, double damping)
{
...
nexdyndiff::RBCLinearVelocityHandler nexdyndiff::RigidBodies::add_constraint_linear_velocity(const RigidBodyHandler& body_a, const RigidBodyHandler& body_b, const Eigen::Vector3d& d_glob, double target_v, double max_force, double delay)
{
	...
	if (max_force < 0.0) {
		std::cout << "nexdyndiff error: RigidBodies::add_constraint_linear_velocity() got a negative force for bodies " << body_a.get_label() << " and " << body_b.get_label() << std::endl;
		exit(-1);
	}
...
nexdyndiff::RBCAngularVelocityHandler nexdyndiff::RigidBodies::add_constraint_angular_velocity(const RigidBodyHandler& body_a, const RigidBodyHandler& body_b, const Eigen::Vector3d& d_glob, double target_w, double max_abs_torque, double delay)
{
	...
	if (max_abs_torque < 0.0) {
		std::cout << "nexdyndiff error: RigidBodies::add_constraint_angular_velocity() got a negative torque for bodies " << body_a.get_label() << " and " << body_b.get_label() << std::endl;
		exit(-1);
	}
...
nexdyndiff::RBCFixHandler nexdyndiff::RigidBodies::add_constraint_fix(const RigidBodyHandler& body)
{
...
nexdyndiff::RBCAttachmentHandler nexdyndiff::RigidBodies::add_constraint_attachment(const RigidBodyHandler& body_a, const RigidBodyHandler& body_b)
{
...
nexdyndiff::RBCPointWithAngleLimitHandler nexdyndiff::RigidBodies::add_constraint_point_with_angle_limit(const RigidBodyHandler& body_a, const RigidBodyHandler& body_b, const Eigen::Vector3d& p_glob, const Eigen::Vector3d& d_glob, const double admissible_angle_deg)
{
...
nexdyndiff::RBCHingeJointHandler nexdyndiff::RigidBodies::add_constraint_hinge(const RigidBodyHandler& body_a, const RigidBodyHandler& body_b, const Eigen::Vector3d& p_glob, const Eigen::Vector3d& d_glob)
{
...
nexdyndiff::RBCHingeJointWithAngleLimitHandler nexdyndiff::RigidBodies::add_constraint_hinge_with_angle_limit(const RigidBodyHandler& body_a, const RigidBodyHandler& body_b, const Eigen::Vector3d& p_glob, const Eigen::Vector3d& d_glob, double admissible_angle_deg)
{
...
nexdyndiff::RBCSliderHandler nexdyndiff::RigidBodies::add_constraint_slider(const RigidBodyHandler& body_a, const RigidBodyHandler& body_b, const Eigen::Vector3d& p_glob, const Eigen::Vector3d& d_glob)
{
...
nexdyndiff::RBCPrismaticSliderHandler nexdyndiff::RigidBodies::add_constraint_prismatic_slider(const RigidBodyHandler& body_a, const RigidBodyHandler& body_b, const Eigen::Vector3d& p_glob, const Eigen::Vector3d& d_glob)
{
...
nexdyndiff::RBCSpringWithLimitsHandler nexdyndiff::RigidBodies::add_constraint_spring_with_limits(const RigidBodyHandler& body_a, const RigidBodyHandler& body_b, const Eigen::Vector3d& a_glob, const Eigen::Vector3d& b_glob, double stiffness, double min_length, double max_length, double damping)
{
...
nexdyndiff::RBCPrismaticPressHandler nexdyndiff::RigidBodies::add_constraint_prismatic_press(const RigidBodyHandler& body_a, const RigidBodyHandler& body_b, const Eigen::Vector3d& p_glob, const Eigen::Vector3d& d_glob, double target_v, double max_force, double delay)
{
...
nexdyndiff::RBCMotorHandler nexdyndiff::RigidBodies::add_constraint_motor(const RigidBodyHandler& body_a, const RigidBodyHandler& body_b, const Eigen::Vector3d& p_glob, const Eigen::Vector3d& d_glob, double target_w, double max_torque, double delay)
{
