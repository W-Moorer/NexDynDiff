...
namespace nexdyndiff
{
	...
	public:
		...
		/* Methods */
		RigidBodyDynamics(core::NexDynDiff& nexdyndiff);
	...
	private:
		void _before_time_step(nexdyndiff::core::NexDynDiff& nexdyndiff);
		void _on_time_step_accepted(nexdyndiff::core::NexDynDiff& nexdyndiff);
	};
