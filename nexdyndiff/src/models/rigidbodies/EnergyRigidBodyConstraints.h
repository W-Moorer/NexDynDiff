...
namespace nexdyndiff
{
	...
	*/
	...
	{
	public:
        EnergyRigidBodyConstraints(core::NexDynDiff& nexdyndiff, const spRigidBodyDynamics rb);
	...
	private:
        /* Methods */
		bool _adjust_constraints_stiffness_and_log(core::NexDynDiff& nexdyndiff, double cap, double multiplier, bool are_positions_set);

		// SymX callbacks
		bool _is_converged_state_valid(core::NexDynDiff& nexdyndiff);
