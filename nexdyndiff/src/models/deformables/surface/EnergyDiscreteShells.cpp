...
nexdyndiff::EnergyDiscreteShells::EnergyDiscreteShells(nexdyndiff::core::NexDynDiff& nexdyndiff, spPointDynamics dyn)
	: dyn(dyn)
{
	...
	nexdyndiff.global_energy.add_energy("EnergyDiscreteShells", this->conn_complete,
	...
	nexdyndiff.global_energy.add_energy("EnergyDiscreteShells_Elasticity_Only", this->conn_elasticity_only,
		[&](symx::Energy& energy, symx::Element& conn)
		{
			// Unpack connectivity
			std::vector<symx::Index> internal_edge = conn.slice(2, 6);
...
nexdyndiff::EnergyDiscreteShells::Handler nexdyndiff::EnergyDiscreteShells::add(const PointSetHandler& set, const std::vector<std::array<int, 3>>& triangles, const Params& params)
{
...
nexdyndiff::EnergyDiscreteShells::Params nexdyndiff::EnergyDiscreteShells::get_params(const Handler& handler) const
{
...
void nexdyndiff::EnergyDiscreteShells::set_params(const Handler& handler, const Params& params)
{
