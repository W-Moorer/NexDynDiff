...
nexdyndiff::EnergyTriangleStrain::EnergyTriangleStrain(nexdyndiff::core::NexDynDiff& nexdyndiff, spPointDynamics dyn)
	: dyn(dyn)
{
	// Energies
	nexdyndiff.global_energy.add_energy("EnergyTriangleStrain", this->conn_complete,
	...
	nexdyndiff.global_energy.add_energy("EnergyTriangleStrain_Elasticity_Only", this->conn_elasticity_only,
		[&](symx::Energy& energy, symx::Element& conn)
		{
			// Unpack connectivity
			std::vector<symx::Index> triangle = conn.slice(2, 5);
...
nexdyndiff::EnergyTriangleStrain::Handler nexdyndiff::EnergyTriangleStrain::add(const PointSetHandler& set, const std::vector<std::array<int, 3>>& triangles, const Params& params)
{
...
nexdyndiff::EnergyTriangleStrain::Params nexdyndiff::EnergyTriangleStrain::get_params(const Handler& handler) const
{
...
void nexdyndiff::EnergyTriangleStrain::set_params(const Handler& handler, const Params& params)
{
