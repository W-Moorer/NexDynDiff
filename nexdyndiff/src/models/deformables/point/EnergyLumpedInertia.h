...
namespace nexdyndiff
{
	...
	*/
	...
	public:
		...
		struct Params 
		{ 
			NEXDYNDIFF_PARAM_NON_NEGATIVE(double, density, 1.0)
			NEXDYNDIFF_PARAM_DAMPING() 
		};
		struct Handler
		{
			NEXDYNDIFF_COMMON_HANDLER_CONTENTS(EnergyLumpedInertia, Params)
	...
	public:
		/* Methods */
		EnergyLumpedInertia(nexdyndiff::core::NexDynDiff& nexdyndiff, const spPointDynamics dyn);
