...
nexdyndiff::EnergyTetStrain::EnergyTetStrain(nexdyndiff::core::NexDynDiff& nexdyndiff, spPointDynamics dyn)
	: dyn(dyn)
{
	nexdyndiff.global_energy.add_energy("EnergyTetStrain", this->conn_complete,
	...
	nexdyndiff.global_energy.add_energy("EnergyTetStrain_Elasticity_Only", this->conn_elasticity_only,
		[&](symx::Energy& energy, symx::Element& conn)
		{
			// Unpack connectivity
			std::vector<symx::Index> tet = conn.slice(2, 6);
...
nexdyndiff::EnergyTetStrain::Handler nexdyndiff::EnergyTetStrain::add(const PointSetHandler& set, const std::vector<std::array<int, 4>>& tets, const Params& params)
{
...
nexdyndiff::EnergyTetStrain::Params nexdyndiff::EnergyTetStrain::get_params(const Handler& handler) const
{
...
void nexdyndiff::EnergyTetStrain::set_params(const Handler& handler, const Params& params)
{
