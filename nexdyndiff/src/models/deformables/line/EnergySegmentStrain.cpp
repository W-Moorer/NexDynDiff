...
nexdyndiff::EnergySegmentStrain::EnergySegmentStrain(nexdyndiff::core::NexDynDiff& nexdyndiff, spPointDynamics dyn)
	: dyn(dyn)
{
	nexdyndiff.global_energy.add_energy("EnergySegmentStrain", this->conn_complete,
	...
	nexdyndiff.global_energy.add_energy("EnergySegmentStrain_Elasticity_Only", this->conn_elasticity_only,
		[&](symx::Energy& energy, symx::Element& conn)
		{
			std::vector<symx::Index> edge = { conn["i"], conn["j"] };
...
nexdyndiff::EnergySegmentStrain::Handler nexdyndiff::EnergySegmentStrain::add(const PointSetHandler& set, const std::vector<std::array<int, 2>>& segments, const Params& params)
{
...
nexdyndiff::EnergySegmentStrain::Params nexdyndiff::EnergySegmentStrain::get_params(const Handler& handler) const
{
...
void nexdyndiff::EnergySegmentStrain::set_params(const Handler& handler, const Params& params)
{
