...
namespace nexdyndiff
{
	...
	public:
		/* Methods */
		DeformablesMeshOutput(core::NexDynDiff& nexdyndiff, spPointDynamics dyn);
	...
	private:
		...
		/* Methods */
		void _write_frame(nexdyndiff::core::NexDynDiff& nexdyndiff);

		template<std::size_t N>
		void _write(nexdyndiff::core::NexDynDiff& nexdyndiff, const nexdyndiff::MeshOutputGroups& groups, const std::vector<nexdyndiff::DeformablesMeshOutput::Mesh<N>>& meshes, std::vector<std::array<int, N>>& conn_buffer);
	};
}
