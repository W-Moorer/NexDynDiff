...
// Ericson05
std::array<double, 2> nexdyndiff::barycentric_point_edge(const Eigen::Vector3d& p, const Eigen::Vector3d& a, const Eigen::Vector3d& b)
{
...
// Ericson05
std::array<double, 2> nexdyndiff::barycentric_edge_edge(const Eigen::Vector3d& A, const Eigen::Vector3d& B, const Eigen::Vector3d& P, const Eigen::Vector3d& Q)
{
	...
	if (denom < 1e-16) {
		std::cout << "error nexdyndiff::barycentric_edge_edge(): parallel edge found." << std::endl;
		exit(-1);
	}
...
std::array<double, 6> nexdyndiff::projection_matrix_triangle(const Eigen::Vector3d& a, const Eigen::Vector3d& b, const Eigen::Vector3d& c)
{
...
std::array<double, 6> nexdyndiff::projection_matrix_edge_edge(const Eigen::Vector3d& a, const Eigen::Vector3d& b, const Eigen::Vector3d& p, const Eigen::Vector3d& q)
{
...
std::array<double, 6> nexdyndiff::projection_matrix_point_point(const Eigen::Vector3d& p, const Eigen::Vector3d& a)
{
...
std::array<double, 6> nexdyndiff::projection_matrix_point_edge(const Eigen::Vector3d& p, const Eigen::Vector3d& a, const Eigen::Vector3d& b)
{
	const Eigen::Vector3d u = (b - a).normalized();
...
double nexdyndiff::edge_edge_mollifier(const Eigen::Vector3d& a, const Eigen::Vector3d& b, const Eigen::Vector3d& p, const Eigen::Vector3d& q, const Eigen::Vector3d& A, const Eigen::Vector3d& B, const Eigen::Vector3d& P, const Eigen::Vector3d& Q)
{
