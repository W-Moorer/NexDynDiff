...
nexdyndiff::EnergyAttachments::EnergyAttachments(core::NexDynDiff& nexdyndiff, const spPointDynamics dyn, const spRigidBodyDynamics rb)
	: dyn(dyn), rb(rb)
{
	// Callbacks
	nexdyndiff.callbacks.add_is_converged_state_valid([&]() { return this->_is_converged_state_valid(nexdyndiff); });

	// Declare the energies
	nexdyndiff.global_energy.add_energy("EnergyAttachments_d_d_p_p", this->conn_d_d_p_p,
	...
	nexdyndiff.global_energy.add_energy("EnergyAttachments_d_d_p_e", this->conn_d_d_p_e,
		[&](symx::Energy& energy, symx::Element& conn)
		{
	...
	nexdyndiff.global_energy.add_energy("EnergyAttachments_d_d_p_t", this->conn_d_d_p_t,
		[&](symx::Energy& energy, symx::Element& conn)
		{
	...
	nexdyndiff.global_energy.add_energy("EnergyAttachments_d_d_e_e", this->conn_d_d_e_e,
		[&](symx::Energy& energy, symx::Element& conn)
		{
	...
	nexdyndiff.global_energy.add_energy("EnergyAttachments_rb_d", this->conn_rb_d,
		[&](symx::Energy& energy, symx::Element& conn)
		{
			// Create symbols
...
nexdyndiff::EnergyAttachments::Handler nexdyndiff::EnergyAttachments::add(const PointSetHandler& set_0, const PointSetHandler& set_1, const std::vector<int>& points_0, const std::vector<int>& points_1, const Params& params)
{
	set_0.exit_if_not_valid("EnergyAttachments::add");
	set_1.exit_if_not_valid("EnergyAttachments::add");

	if (points_0.size() != points_1.size()) {
		std::cout << "nexdyndiff error: EnergyAttachments::add() found an invalid number of points." << std::endl;
		exit(-1);
	}
...
nexdyndiff::EnergyAttachments::Handler nexdyndiff::EnergyAttachments::add(const PointSetHandler& set_0, const PointSetHandler& set_1, const std::vector<int>& points, const std::vector<std::array<int, 2>>& edges, const std::vector<std::array<double, 2>>& bary, const Params& params)
{
	set_0.exit_if_not_valid("EnergyAttachments::add");
	set_1.exit_if_not_valid("EnergyAttachments::add");
	...
	if (edges.size() != n || bary.size() != n) {
		std::cout << "nexdyndiff error: EnergyAttachments::add() found an invalid input sizes." << std::endl;
		exit(-1);
	}
...
nexdyndiff::EnergyAttachments::Handler nexdyndiff::EnergyAttachments::add(const PointSetHandler& set_0, const PointSetHandler& set_1, const std::vector<int>& points, const std::vector<std::array<int, 3>>& triangles, const std::vector<std::array<double, 3>>& bary, const Params& params)
{
	set_0.exit_if_not_valid("EnergyAttachments::add");
	set_1.exit_if_not_valid("EnergyAttachments::add");
...
nexdyndiff::EnergyAttachments::MultiHandler nexdyndiff::EnergyAttachments::add_by_distance(const PointSetHandler& set_0, const PointSetHandler& set_1, const std::vector<int>& points, const std::vector<std::array<int, 3>>& triangles, const double distance, const Params& params)
{
	set_0.exit_if_not_valid("EnergyAttachments::add");
	set_1.exit_if_not_valid("EnergyAttachments::add");
...
nexdyndiff::EnergyAttachments::Handler nexdyndiff::EnergyAttachments::add(const RigidBodyHandler& rb, const PointSetHandler& set, const std::vector<Eigen::Vector3d>& rb_points_loc, const std::vector<int>& set_points, const Params& params)
{
...
nexdyndiff::EnergyAttachments::Handler nexdyndiff::EnergyAttachments::add(const RigidBodyHandler& rb, const PointSetHandler& set, const std::vector<int>& points, const Params& params)
{
	rb.exit_if_not_valid("EnergyAttachments::add");
	set.exit_if_not_valid("EnergyAttachments::add");
...
nexdyndiff::EnergyAttachments::Handler nexdyndiff::EnergyAttachments::add_by_distance(const RigidBodyHandler& rb, const PointSetHandler& set, const std::vector<Eigen::Vector3d>& loc_vertices, const std::vector<std::array<int, 3>>& triangles, const std::vector<int>& set_points, const double distance, const Params& params)
{
	rb.exit_if_not_valid("EnergyAttachments::add");
	set.exit_if_not_valid("EnergyAttachments::add");
...
nexdyndiff::EnergyAttachments::Params nexdyndiff::EnergyAttachments::get_params(const Handler& handler) const
{
	...
	default:
		std::cout << "nexdyndiff error: EnergyAttachments::get_params() found an invalid handler type." << std::endl;
		exit(-1);
	}
}
void nexdyndiff::EnergyAttachments::set_params(const Handler& handler, const Params& params)
{
	...
	case AttachmentType::Rigid_Deformable:
		...
		break;
	default:
		std::cout << "nexdyndiff error: EnergyAttachments::set_params() found an invalid handler type." << std::endl;
		exit(-1);
	}
}

bool nexdyndiff::EnergyAttachments::_is_converged_state_valid(core::NexDynDiff& nexdyndiff)
{
	...
	if (!is_valid) {
		nexdyndiff.console.add_error_msg("Attachment constraints are not within tolerance. Stiffness hardened.");
	}
