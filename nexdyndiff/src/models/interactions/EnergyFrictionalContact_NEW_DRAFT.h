...
namespace nexdyndiff
{
	...
	private:
		...
		void _update_contacts_static(core::NexDynDiff& nexdyndiff);
		bool _intersection_static(core::NexDynDiff& nexdyndiff);
		void _update_friction_static(core::NexDynDiff& nexdyndiff);
		...
		bool _is_valid_configuration(core::NexDynDiff& nexdyndiff);
		...
		void _energies_contact_static(core::NexDynDiff& nexdyndiff);
		...
		void _energies_friction_static(core::NexDynDiff& nexdyndiff);
		...
		// SymX setters
		void _set_barrier_potential(symx::Energy& energy, const core::NexDynDiff& nexdyndiff, const symx::Scalar& d);
		void _set_edge_edge_mollified_barrier_potential(symx::Energy& energy, const core::NexDynDiff& nexdyndiff, const symx::Scalar& d, const std::vector<symx::Vector>& ea, const std::vector<symx::Vector>& eb, const std::vector<symx::Vector>& ea_rest, const std::vector<symx::Vector>& eb_rest);
