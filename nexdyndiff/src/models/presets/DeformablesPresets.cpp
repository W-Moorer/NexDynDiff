...
nexdyndiff::DeformablesPresets::DeformablesPresets(core::NexDynDiff& nexdyndiff, std::shared_ptr<Deformables> deformables, std::shared_ptr<Interactions> interactions)
	: deformables(deformables), interactions(interactions)
{
}

nexdyndiff::Line::Handler nexdyndiff::DeformablesPresets::add_line(const std::string& output_label, const std::vector<Eigen::Vector3d>& vertices, const std::vector<std::array<int, 2>>& segments, const Line::Params& params)
{
...
nexdyndiff::Line::VCH nexdyndiff::DeformablesPresets::add_line_as_segments(const std::string& output_label, const Eigen::Vector3d& begin, const Eigen::Vector3d& end, const int n_segments, const Line::Params& params)
{
...
nexdyndiff::Surface::Handler nexdyndiff::DeformablesPresets::add_surface(const std::string& output_label, const std::vector<Eigen::Vector3d>& vertices, const std::vector<std::array<int, 3>>& triangles, const Surface::Params& params)
{
	PointSetHandler point_set = this->deformables->point_sets->add(vertices);
...
nexdyndiff::Surface::VCH nexdyndiff::DeformablesPresets::add_surface_grid(const std::string& output_label, const Eigen::Vector2d& dim, const std::array<int, 2>& subdivisions, const Surface::Params& params)
{
...
nexdyndiff::PrescribedSurface::Handler nexdyndiff::DeformablesPresets::add_prescribed_surface(const std::string& output_label, const std::vector<Eigen::Vector3d>& vertices, const std::vector<std::array<int, 3>>& triangles, const PrescribedSurface::Params& params)
{
	PointSetHandler point_set = this->deformables->point_sets->add(vertices);
...
nexdyndiff::Volume::Handler nexdyndiff::DeformablesPresets::add_volume(const std::string& output_label, const std::vector<Eigen::Vector3d>& vertices, const std::vector<std::array<int, 4>>& tets, const Volume::Params& params)
{
	auto [surface_triangles, tri_to_tet_map] = nexdyndiff::find_surface(vertices, tets);
...
nexdyndiff::Volume::VCH nexdyndiff::DeformablesPresets::add_volume_grid(const std::string& output_label, const Eigen::Vector3d& dim, const std::array<int, 3>& subdivisions, const Volume::Params& params)
{
