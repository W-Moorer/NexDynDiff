...
namespace nexdyndiff
{
	...
	public:
		/* Methods */
		Presets(core::NexDynDiff& nexdyndiff, std::shared_ptr<Deformables> deformables, std::shared_ptr<RigidBodies> rigidbodies, std::shared_ptr<Interactions> interactions);
