...
nexdyndiff::RigidBody::Handler nexdyndiff::RigidBodyPresets::add(
...
nexdyndiff::RigidBody::VCH nexdyndiff::RigidBodyPresets::add_sphere(const std::string& output_label, double mass, double radius, int subdivisions, const ContactParams& contact_params)
{
...
nexdyndiff::RigidBody::VCH nexdyndiff::RigidBodyPresets::add_box(const std::string& output_label, double mass, const Eigen::Vector3d& size, const ContactParams& contact_params)
{
...
nexdyndiff::RigidBody::VCH nexdyndiff::RigidBodyPresets::add_box(const std::string& output_label, double mass, double size, const ContactParams& contact_params)
{
	return this->add_box(output_label, mass, { size, size, size }, contact_params);
}
nexdyndiff::RigidBody::VCH nexdyndiff::RigidBodyPresets::add_cylinder(const std::string& output_label, double mass, double radius, double full_height, int slices, int stacks, const ContactParams& contact_params)
{
...
nexdyndiff::RigidBody::VCH nexdyndiff::RigidBodyPresets::add_torus(const std::string& output_label, double mass, double outer_radius, double inner_radius, int slices, int stacks, const ContactParams& contact_params)
{
