...
nexdyndiff::Line::Params::Params(const Preset& preset)
{
	switch (preset)
	{
...
nexdyndiff::Line::Params nexdyndiff::Line::Params::Elastic_Rubberband()
{
	return Params(Preset::Elastic_Rubberband);
}


nexdyndiff::Surface::Params::Params(const Preset& preset)
{
	switch (preset)
	{
...
nexdyndiff::Surface::Params nexdyndiff::Surface::Params::Cotton_Fabric()
{
	return Params(Preset::Cotton_Fabric);
}

nexdyndiff::Volume::Params::Params(const Preset& preset)
{
	switch (preset)
	{
...
nexdyndiff::Volume::Params nexdyndiff::Volume::Params::Soft_Rubber()
{
